...
";  interleave: Interleave ratio (typically between 1 and 8)\n"
		...
		{ MIXER_SECTION,
"; Volumes are expressed as positive numbers between 0 and " MIXER_MAX_VOLUME_STR ", where 100 is nominal.\n"
"; Balances are numbers between -100 and 100, where -100 = full left, 0 = center, 100 = full right\n"
";\n"
...
";               file: write output to a regular file\n"
...
";               pipe-server: named pipe server (Windows only)\n"
";               pipe-client: named pipe client or virtual COM connection (Windows only)\n"
...
";      port_b: Mode of operation of port B (see port_a).\n"
...
AppConfig::ConfigSections AppConfig::ms_sections = {
	...
	{ DISPLAY_SECTION, {
		...
		{ DISPLAY_CURSOR_INVERT,    PROGRAM_CONFIG, HIDDEN_CFGKEY, "no"                          },
		{ DISPLAY_BLINK_RATE,       PROGRAM_CONFIG, HIDDEN_CFGKEY, "32"                          },
		{ DISPLAY_CURSOR_BLINK_RATE,PROGRAM_CONFIG, HIDDEN_CFGKEY, "16"                          },
	...
	{ MIXER_SECTION, {
		...
		{ MIXER_VOLUME,    MIXER_CONFIG,   PUBLIC_CFGKEY, "100"               },
	} },
	{ MIDI_SECTION, {
	...
	{ PCSPEAKER_SECTION, {
		{ PCSPEAKER_LEVEL,   PROGRAM_CONFIG, HIDDEN_CFGKEY, "0.50"  },
		{ PCSPEAKER_VOLUME,  MIXER_CONFIG,   PUBLIC_CFGKEY, "100"   },
		{ PCSPEAKER_BALANCE, MIXER_CONFIG,   PUBLIC_CFGKEY, "0"     },
		{ PCSPEAKER_FILTERS, MIXER_CONFIG,   PUBLIC_CFGKEY, "pc-speaker-1" },
	...
	{ SOUNDFX_SECTION, {
		...
		{ SOUNDFX_SYSTEM,         MIXER_CONFIG,   PUBLIC_CFGKEY, "100"  },
		{ SOUNDFX_SYSTEM_BALANCE, MIXER_CONFIG,   PUBLIC_CFGKEY, "0.0"  },
		{ SOUNDFX_MODEM,          MIXER_CONFIG,   PUBLIC_CFGKEY, "120"  },
		{ SOUNDFX_MODEM_FILTERS,  MIXER_CONFIG,   HIDDEN_CFGKEY, "auto" },
		{ SOUNDFX_MODEM_BALANCE,  MIXER_CONFIG,   PUBLIC_CFGKEY, "-50"  },
